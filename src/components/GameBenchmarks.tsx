      ...
      <CardContent>
        <Tabs defaultValue="games" className="w-full">
          ...
          <TabsContent value="games" className="space-y-4 mt-4">
            {onViewGameBenchmarks && gamePerformances.length > 0 && (
              <div className="flex justify-end mb-4">
                <Button variant="outline" size="sm" onClick={onViewGameBenchmarks} className="gap-1">
                  View All Games
          ...
          <TabsContent value="applications" className="space-y-4 mt-4">
            {onViewApplicationBenchmarks && applicationPerformances.length > 0 && (
              <div className="flex justify-end mb-4">
                <Button variant="outline" size="sm" onClick={onViewApplicationBenchmarks} className="gap-1">
